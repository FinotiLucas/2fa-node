import {
  colors,
  htmlEscape
} from "./chunk-QCCVRN3N.js";
import {
  publicDirURL
} from "./chunk-OSUFJZHZ.js";
import {
  BaseComponent
} from "./chunk-KMDKVT27.js";
...
var ErrorStack = class extends BaseComponent {
   ...
   */
  #renderFrameLocation(frame, id, ide) {
  ...
  async #renderStackFrame(frame, index, expandAtIndex, props) {
    ...
    const toggleButton = frame.type !== "native" && frame.source ? `<button class="stack-frame-toggle-indicator" onclick="toggleFrameSource(event, '${id}')">
          ${CHEVIRON}
        </button>` : "";
